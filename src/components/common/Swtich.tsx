...
const Switch = ({ value, onChange, checked }: { value: Rate, onChange: () => void, checked:boolean }) => {
    ...
    return (
      <div className='my-auto'>
        <label className="relative mt-5px inline-flex items-center cursor-pointer h-28px m-auto">
